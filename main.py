    ...
    <div class="container">
        ...
        <main class="row">
            <div class="row text-center">
                ...
                <form class="col-6">
                    <div class="mb-3">
                      <input name="name" type="name" placeholder="name" class="form-control" id="exampleInputName">
                    </div>
                    <div class="mb-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>4</td>
                        <td>1600</td>
                        <td class="alert alert-danger" role="alert">отмена</td>
                      </tr>
                      <tr>
                        <th scope="row">5</th>
                        <td>Товар5</td>
                ...
                <p class="mt-3">
                    <button class="col-3 btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample2">
                        Как купить?
                    </button>
                    <button class="col-3 btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample2" aria-expanded="false" aria-controls="collapseExample2">
                        Как доставить?
                    </button>
                    <button class="col-3 btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample3" aria-expanded="false" aria-controls="collapseExample3">
                        Какая гарантия?
                    </button>
                  </p>
